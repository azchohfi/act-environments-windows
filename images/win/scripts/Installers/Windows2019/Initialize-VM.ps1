...
New-Item -Path $env:temp\ -Name cmds.txt -ItemType File -Force

Add-Content -Path $env:temp\cmds.txt "SELECT VOLUME=C`r`nEXTEND"
$cmdsPath = $env:temp + '\cmds.txt'
$expandResult = (diskpart /s $cmdsPath)
